...
import nuxt_plugin_recaptcha_0e136224 from 'nuxt_plugin_recaptcha_0e136224' // Source: ./recaptcha.js (mode: 'all')
import nuxt_plugin_axios_4046f635 from 'nuxt_plugin_axios_4046f635' // Source: ./axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"FICAT | Sistema De Geração Automática de Ficha Catalográfica","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Nuxt-Vue.js Ficat version"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"},{"rel":"stylesheet","href":"https:\u002F\u002Fcdn.jsdelivr.net\u002Fnpm\u002F@mdi\u002Ffont@5.8.55\u002Fcss\u002Fmaterialdesignicons.min.css"}],"htmlAttrs":{"class":"htmlClass","lang":"pt-BR"},"bodyAttrs":{"class":"bodyClass"},"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_recaptcha_0e136224 === 'function') {
    await nuxt_plugin_recaptcha_0e136224(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_4046f635 === 'function') {
    await nuxt_plugin_axios_4046f635(app.context, inject)
  }
