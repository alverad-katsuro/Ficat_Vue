export default {
  ...
  layout: {
    ...
    workTitle: 'Título do trabalho (Campo obrigatório)',
    workTitleTooltip:
    ...
    workSubtitleTooltip:
      'Digite o subtítulo do trabalho iniciando com letra minúscula e utilizando letras maiúsculas somente para nomes próprios. Campo Opcional',
    year: 'Ano',
    yearTooltip: 'Selecione o ano de defesa do seu trabalho.',
    totalPages: 'Total de Páginas (Campo obrigatório)',
    arabic: 'Arábicos',
    roman: 'Romanos',
    numberTypeTooltip:
    ...
    knArea: 'Área de Conhecimento (Campo obrigatório)',
    knAreaTooltip:
    ...
    acdUnity: 'Unidade Acadêmica (Campo obrigatório)',
    acdUnityTooltip:
      'Selecione a unidade acadêmica a que seu curso está vinculado.',
    course: 'Curso (Campo obrigatório)',
    courseTooltip: 'Selecione seu curso',
    noResultFound: 'Nenhum resultado encontrado',
    orientationData: 'Orientadores',
    advisor: 'Orientador',
    advisorTooltip:
      'Digite o nome completo do seu orientador(a) ou coorientador(a). No botão ao lado direito selecione a quem se refere essa informação, isto é, se é um orientador(a) ou coorientador(a).',
    ...
    advisorGender: 'Gênero (Campo obrigatório)',
    genderMale: 'Masculino',
    genderFemale: 'Feminino',
    advisorName: 'Nome completo (Campo obrigatório)',
    ...
    removeCoadvisor: 'Remover orientador ou coorientador',
    vocabulary:
    ...
    talkFormMessageTooltip:
      'Digite uma mensagem descrevendo a questão. Minimo de 20 caracteres',
