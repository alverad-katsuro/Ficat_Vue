        ...
        <div class="column is-half">
          <div class="input-float">
            ...
            <input-validation
              ...
              :aria-label="$tr('layout.knArea')"
              :label="$tr('layout.knArea')"
              :tooltip-label="$tr('layout.knAreaTooltip')"
              @keypress.enter="option => (selectedKnArea = option)"
            ...
            <input-validation
              ...
              @keypress.enter="onSelectedAcdUnity"
